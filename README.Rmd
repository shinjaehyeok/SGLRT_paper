...
The following Rcode reproduces the Fig. 5 in Section IV-C in which we compared ratios of widths of confidence intervals to the poinstwise and asymptotically valid normal confidence intervals based on the central limit theorem.
